"""Verify that mcp.version and mcp_sonos.__version__ agree and equal 0.3.0."""
...
def test_package_version() -> None:
    assert mcp_sonos.__version__ == "0.3.0"
...
def test_mcp_version_is_not_fastmcp_version() -> None:
    # FastMCP's own framework version starts with 3.x; project version is 0.3.0.
